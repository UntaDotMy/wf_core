# Git Expert Operating Checklist
...
- Confirm branch safety and current worktree protection.
- Confirm commit, pr, merge, and conflict hygiene.
- Confirm recovery paths without destructive history changes.
