# Memory Status Reporter Operating Checklist
...
- Confirm global rules and durable learning summaries.
- Confirm mistake ledger status and resolved/unresolved split.
- Confirm user preference summaries without secret inference.
