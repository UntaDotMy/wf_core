# Software Development Life Cycle Operating Checklist
...
- Confirm working brief, sequencing, and dependency management.
- Confirm architecture tradeoffs and brownfield constraints.
- Confirm implementation, validation, review, and closure proof.
