# Web Development Life Cycle Operating Checklist
...
- Confirm web architecture, routing, state, and browser behavior.
- Confirm performance, seo, compatibility, and security headers.
- Confirm testing, deployment, monitoring, and rollback.
